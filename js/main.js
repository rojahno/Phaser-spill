...
//^^ link to the phaser start project. 
...
PlayState = {
    ...
    preload: function () {
        ...
        //Loads the enemies sprite
        this.game.load.spritesheet('spider', 'images/spider.png', 42, 32);

        //Loads the sprites for the platform.
    ...
    _handleCollisions: function () {
        ...
        //Overlap of hero and coins.
        this.game.physics.arcade.overlap(this.hero, this.coins, this._onHeroVsCoin,
            null, this);

        //Overlap of hero and spider.
